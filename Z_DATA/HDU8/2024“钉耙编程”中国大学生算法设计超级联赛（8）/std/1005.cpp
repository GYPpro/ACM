...
LL c1[70],c2[70];
LL nc1[70],nc2[70];
inline void Add(const LL l,const LL *c,const int flag,const LL l1,const LL l2)
{
	if(l<=0)
	{
		return;
...
inline void Work()
{
	...
	while(l1>0||l2>0)
	{
		...
		Add((l1-1)/2,c1,1,ne1,ne2);
		Add(l1-1-(l1-1)/2,c1,0,ne1,ne2);
		Add((l2-1)/2,c2,1,ne1,ne2);
		Add(l2-1-(l2-1)/2,c2,0,ne1,ne2);
		l1=ne1;
		l2=ne2;
		REP(i,0,k)
		{
