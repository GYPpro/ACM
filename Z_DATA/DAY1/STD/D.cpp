...
int main()
{
    ...
    auto query = [&](ll x)
    {
        ...
        {
            int r = x & ((1 << (b + 1)) - 1);
            // cout << query_bit(b, (1 << b) - r, (1 << (b + 1)) - 1 - r) << " " << (n - query_bit(b, (1 << (b + 1)) - r, (3 << b) - 1 - r)) << "\n";
            if (r <= (1 << b))
                res += (query_bit(b, (1 << b) - r, (1 << (b + 1)) - 1 - r) & 1) << b,cout << query_bit(b, (1 << b) - r, (1 << (b + 1)) - 1 - r) << "a\n";//
            else
                res += ((n - query_bit(b, (1 << (b + 1)) - r, (3 << b) - 1 - r)) & 1) << b,cout << (n - query_bit(b, (1 << (b + 1)) - r, (3 << b) - 1 - r)) << "b\n";//
            // cout << (res >> b )<< " ";
        }
        return res;
    };
